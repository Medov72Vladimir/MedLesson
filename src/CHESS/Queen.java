        ...
        if (line != toLine && column != toColumn &&
            ...
            if ((column == getMin(column, toColumn) && line == getMax(line, toLine)) ||
                ...
                for (int i = 1; i < toC - fromC; i++) {
                    ...
                    } else if (!chessBoard.board[fromL - i][fromC + i].getColor().equals(this.getColor()) && fromL - i == toLine) {
                        positions[i - 1] = new int[]{fromL - i, fromC + i};
                    } else {
                        return false;
                    }
            ...
            if (column == toColumn) {
                ...
                for (int i = getMin(line, toLine); i < getMax(line, toLine); i++) {
                    if (chessBoard.board[i][column] != null) {
                        ...
                        else if (chessBoard.board[i][column].getColor().equals(this.getColor()) && i == toLine)
                            return false;
                        else if (!chessBoard.board[i][column].getColor().equals(this.getColor()) && i == toLine)
                            return true;
                ...
                if (chessBoard.board[toLine][column] != null) {
                    if (chessBoard.board[toLine][column].getColor().equals(this.getColor()) && chessBoard.board[toLine][column] != this)
                        return false;
                    else return !chessBoard.board[toLine][column].getColor().equals(this.getColor()) && chessBoard.board[toLine][column] != this;
                } else return true;
            } else if (line == toLine) {
                ...
                for (int i = getMin(toColumn, column); i < getMax(column, toColumn); i++) {
                    if (chessBoard.board[line][i] != null) {
                        ...
                        else if (chessBoard.board[line][i].getColor().equals(this.getColor()) && i == toColumn)
                            return false;
                        else if (!chessBoard.board[line][i].getColor().equals(this.getColor()) && i == toColumn)
                            return true;
                ...
                if (chessBoard.board[toLine][toColumn] != null) {
                    if (chessBoard.board[toLine][toColumn].getColor().equals(this.getColor()) && chessBoard.board[toLine][toColumn] != this)
                        return false;
                    else return !chessBoard.board[toLine][toColumn].getColor().equals(this.getColor()) && chessBoard.board[toLine][toColumn] != this;
                } else return true;
            } else return false;
        } else return false;
    }
