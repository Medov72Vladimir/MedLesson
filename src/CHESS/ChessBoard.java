package CHESS;
/*
 Чтобы было куда-то ставить фигуры, для этого нам нужен класс доски (ChessBoard),
  который будет отвечать за управление всей игрой
 */
public class ChessBoard {
    ...
    public String nowPlayerColor() { //геттер
        return this.nowPlayer;
    }

    //Метод moveToPosition() передвигает фигуры, используя результат работы метода canMoveToPosition()(можно или нельзя)
    ...
    public void printBoard() {  //печатает поле с помощью двойного цикла проходясь по массиву фигур
    ...
    /*
    Метод castling0() отвечает за рокировку по 0 линии
     */
    ...
    /*
    Метод castling7()позволяет проверить, возможна ли рокировка белого короля с ладьей,
    стоящей в 7 столбце, и если возможна, то совершить рокировку
     */
